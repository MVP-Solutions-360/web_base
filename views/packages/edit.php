...
<head>
    ...
    <title>Editar Paquete - Panel Admin</title>
    ...
    <div class="admin-wrapper">
        ...
        <main class="admin-content">
            <div class="admin-header">
                ...
                <p>Actualiza la informacion del paquete</p>
            </div>

            <section class="admin-card form-container">
                <?php if (empty($package)): ?>
                    <p class="empty">Paquete no encontrado.</p>
                    <a class="btn btn-outline" href="/routes/web.php?url=packages/list"><i class="fas fa-arrow-left"></i> Volver al listado</a>
                <?php else: ?>
                    <form id="packageEditForm" method="POST" action="/routes/web.php?url=packages/update" class="admin-form" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="text" name="name" required minlength="3" maxlength="120" value="<?= htmlspecialchars($package['nombre'] ?? ($package['name'] ?? '')) ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="citySelect" name="city_id" required>
                                ...
                                <?php foreach ($cities as $c): ?>
                                    <option value="<?= (int) $c['id'] ?>" <?= (int)($package['city_id'] ?? $package['ciudad_id'] ?? 0) === (int)$c['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="form-actions">
                            <button class="btn" type="submit"><i class="fas fa-save"></i> Actualizar paquete</button>
